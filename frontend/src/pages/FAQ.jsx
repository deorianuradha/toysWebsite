      ...
      order: [
        {
          ...
          answer:
            "Navigate to the shop and select product you wish to buy, and click 'Add to Cart' icon. Proceed to checkout to place your order.",
        },
        {
...
return ( 
    ...
    <div className="flex mt-[6rem] ml-[5rem]">
