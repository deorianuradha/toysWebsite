  ...
  return (
    <div className="container mx-auto p-8 mt-[5rem]">
      ...
      <div className="mb-8">
        ...
        <p>
          Biodegradable-Toys Toy Shop reserves the right to accept the cancellation of any order.
          Biodegradable-Toys Toy Shop also reserves the right to waive off or modify the time
